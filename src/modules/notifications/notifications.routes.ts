...
/** @openapi /notifications: get: { summary: List own in-app notifications, tags: [Notifications], security: [{ bearerAuth: [] }] } */
notificationsRoutes.get('/', requireAuth, validate({ query: listNotificationsSchema }), notificationsController.list);

/** @openapi /notifications/{id}/read: patch: { summary: Mark a notification as read, tags: [Notifications], security: [{ bearerAuth: [] }] } */
