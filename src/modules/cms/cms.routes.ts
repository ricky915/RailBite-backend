...
/** @openapi /cms/homepage: get: { summary: Homepage hero/offer content, tags: [CMS] } */
cmsRoutes.get('/homepage', cmsController.getHomepage);
/** @openapi /cms/faqs: get: { summary: FAQ list, tags: [CMS] } */
cmsRoutes.get('/faqs', cmsController.getFaqs);
/** @openapi /cms/privacy-policy: get: { summary: Privacy policy text, tags: [CMS] } */
cmsRoutes.get('/privacy-policy', cmsController.getPrivacyPolicy);
/** @openapi /cms/terms: get: { summary: Terms & conditions text, tags: [CMS] } */
cmsRoutes.get('/terms', cmsController.getTerms);
/** @openapi /cms/settings: get: { summary: Site settings (social links, contact info), tags: [CMS] } */
...
/** @openapi /admin/cms/homepage: put: { summary: Update homepage content, tags: [CMS], security: [{ bearerAuth: [] }] } */
...
/** @openapi /admin/cms/faqs: put: { summary: Update FAQ list, tags: [CMS], security: [{ bearerAuth: [] }] } */
adminCmsRoutes.put('/faqs', requireAuth, requireRole(...adminRoles), validate({ body: faqContentSchema }), cmsController.updateFaqs);
/** @openapi /admin/cms/privacy-policy: put: { summary: Update privacy policy, tags: [CMS], security: [{ bearerAuth: [] }] } */
adminCmsRoutes.put(
  '/privacy-policy',
  requireAuth,
...
/** @openapi /admin/cms/terms: put: { summary: Update terms & conditions, tags: [CMS], security: [{ bearerAuth: [] }] } */
adminCmsRoutes.put('/terms', requireAuth, requireRole(...adminRoles), validate({ body: legalContentSchema }), cmsController.updateTerms);
/** @openapi /admin/cms/settings: put: { summary: Update site settings, tags: [CMS], security: [{ bearerAuth: [] }] } */
